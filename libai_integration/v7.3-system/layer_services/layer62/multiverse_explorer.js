...
if (require.main === module) {
  const s = new Multiverse_explorer(20323, 62, 'multiverse_explorer');
  s.start();
  require('http').createServer((req, res) => {
    res.writeHead(200); res.end(JSON.stringify(s.getStatus()));
  }).listen(parseInt(process.env.PORT) || 20323);
}
module.exports = Multiverse_explorer;
