class System_integrity_checker {
...
if (require.main === module) {
  const s = new System_integrity_checker(20344, 66, 'system_integrity_checker');
  s.start();
  require('http').createServer((req, res) => {
    res.writeHead(200); res.end(JSON.stringify(s.getStatus()));
  }).listen(parseInt(process.env.PORT) || 20344);
}
module.exports = System_integrity_checker;
