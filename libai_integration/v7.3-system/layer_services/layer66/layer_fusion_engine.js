...
if (require.main === module) {
  const s = new Layer_fusion_engine(20340, 66, 'layer_fusion_engine');
  s.start();
  require('http').createServer((req, res) => {
    res.writeHead(200); res.end(JSON.stringify(s.getStatus()));
  }).listen(parseInt(process.env.PORT) || 20340);
}
module.exports = Layer_fusion_engine;
