...
if (require.main === module) {
  const s = new Omnipotence_simulator(20361, 70, 'omnipotence_simulator');
  s.start();
  require('http').createServer((req, res) => {
    res.writeHead(200); res.end(JSON.stringify(s.getStatus()));
  }).listen(parseInt(process.env.PORT) || 20361);
}
module.exports = Omnipotence_simulator;
