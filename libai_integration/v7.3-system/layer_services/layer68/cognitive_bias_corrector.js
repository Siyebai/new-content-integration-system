class Cognitive_bias_corrector {
...
if (require.main === module) {
  const s = new Cognitive_bias_corrector(20354, 68, 'cognitive_bias_corrector');
  s.start();
  require('http').createServer((req, res) => {
    res.writeHead(200); res.end(JSON.stringify(s.getStatus()));
  }).listen(parseInt(process.env.PORT) || 20354);
}
module.exports = Cognitive_bias_corrector;
