...
if (require.main === module) {
  const s = new Swarm_intelligence(20346, 67, 'swarm_intelligence');
  s.start();
  require('http').createServer((req, res) => {
    res.writeHead(200); res.end(JSON.stringify(s.getStatus()));
  }).listen(parseInt(process.env.PORT) || 20346);
}
module.exports = Swarm_intelligence;
