class Collective_consciousness {
...
if (require.main === module) {
  const s = new Collective_consciousness(20347, 67, 'collective_consciousness');
  s.start();
  require('http').createServer((req, res) => {
    res.writeHead(200); res.end(JSON.stringify(s.getStatus()));
  }).listen(parseInt(process.env.PORT) || 20347);
}
module.exports = Collective_consciousness;
