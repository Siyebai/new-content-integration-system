...
if (require.main === module) {
  const s = new Recursive_improvement(20356, 69, 'recursive_improvement');
  s.start();
  require('http').createServer((req, res) => {
    res.writeHead(200); res.end(JSON.stringify(s.getStatus()));
  }).listen(parseInt(process.env.PORT) || 20356);
}
module.exports = Recursive_improvement;
